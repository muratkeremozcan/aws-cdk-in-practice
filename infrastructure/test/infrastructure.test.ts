...
describe('Testing Chapter 8 code.', () => {
  ...
  test('The stack has a ECS cluster configured in the right way.', () => {
    ...
    const template = Template.fromStack(finalStack)
      ...
      ContainerDefinitions: [
        {
          ...
          LogConfiguration: {
            ...
            Options: {
              ...
              'awslogs-stream-prefix': Match.stringLikeRegexp('chapter8'),
  ...
  it('Matches the snapshot.', () => {
    ...
    const chapter8Stack = new FinalStack(stack, 'Chapter8Stack', {
      env: {
        region: parsed?.CDK_DEFAULT_REGION,
        account: parsed?.CDK_DEFAULT_ACCOUNT,
      },
